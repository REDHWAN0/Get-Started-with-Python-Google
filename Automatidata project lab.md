...
Here's how I can best prepare to understand and organize the provided taxi cab information:

1. Review the data dictionary:
This document provides crucial information about each data point, including its meaning, format, and potential units. Understanding the data dictionary will help me interpret the values correctly and identify any inconsistencies.

2. Familiarize with the project goals:
Understanding the overall objectives of the project will guide my data exploration and organization efforts. Knowing what insights are being sought will help me prioritize relevant information and identify key variables.

3. Utilize existing resources:
Leverage the initial exploration completed by Luana Rodriguez. This can provide valuable insights into the data structure and potential areas of focus.

4. Refresh your Python skills:
If needed, brush up on my Python skills, particularly regarding data manipulation libraries like pandas. 

5. Start with an exploratory mindset:
Approach the data with curiosity and a willingness to learn. Look for patterns, trends, and potential issues that require further investigation.
...
**Answer:** I noticed that the data frame has 0 null values. And the columns that do not have numeric variables are "tpep_pickup_datetime", "tpep_dropoff_datetime " and "store_and_fwd_flag"
...
Answer 1: I consider that the min value for trip distance is not normal since they moved a distance of 0.00 meters and that they spent like 1 minute in the ride.

Answer 2: The total amount the clients in the first row and second row paid is really high(1200.29)and (450.00) compared to client in the third row since the first client moved 2.60 km, the second moved 0.00 km, and the third client moved 33.92 and paid 258.21

Answer 3: The result rows is not the same because the variable sort is different.
...
avg_credit_card_tip =df[df['payment_type'] ==1]['tip_amount'].mean()
print('Avg. credit card tip', avg_credit_card_tip)
