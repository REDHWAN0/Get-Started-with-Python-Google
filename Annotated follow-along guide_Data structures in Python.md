...
new_fruits = [fruit for fruit in fruits if fruit != 'Strawberry']
print(fruits)
```
...
```
    ...
    ['Pineapple', 'Mango', 'Apple', 'Melon', 'Kiwi']
...
```
    ...
    <ipython-input-103-00e5a49431dc> in <module>
...
```
    ...
    <ipython-input-109-6538832964d3> in <module>
...
```
    ...
    <ipython-input-129-b6ebad30fd16> in <module>
          3 list_b = [2, 4, 6]
          4 
    ----> 5 list_a * list_b
...
```
    ...
    <ipython-input-134-12d7534cf085> in <module>
...
```
    ...
    <pandas.core.groupby.generic.DataFrameGroupBy object at 0x7f077a2dce50>
